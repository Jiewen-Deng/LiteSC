...
# -*- coding:utf-8 _*-
"""
Preprocess the europarl copus and convert them to indicies.
@Author: JW Deng
@Time: 2026/7/6 16:44
"""
# !/usr/bin/env python3
...
parser.add_argument('--data-dir', default='/europarl/europarl_ennew_nocut/', type=str)
parser.add_argument('--input-data-dir', default='ennew', type=str)
parser.add_argument('--output-train-dir', default='ennew/out/train_data.pkl', type=str)
parser.add_argument('--output-test-dir', default='ennew/out/test_data.pkl', type=str)
parser.add_argument('--output-vocab', default='ennew/out/vocab.json', type=str)
...
def main(args):
    args.input_data_dir = args.data_dir + args.input_data_dir
    args.output_train_dir = args.data_dir + args.output_train_dir
    args.output_test_dir = args.data_dir + args.output_test_dir
    args.output_vocab = args.data_dir + args.output_vocab
